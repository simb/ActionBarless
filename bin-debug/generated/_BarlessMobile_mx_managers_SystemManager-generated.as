...
public class _BarlessMobile_mx_managers_SystemManager
    extends mx.managers.SystemManager
    implements IFlexModuleFactory, ISWFContext
{
    public function _BarlessMobile_mx_managers_SystemManager()
    {
    ...
    override     public function create(... params):Object
    {
        ...
        var mainClassName:String = params.length == 0 ? "BarlessMobile" : String(params[0]);
    ...
    override    public function info():Object
    {
        if (!_info)
        {
            ...
            compiledResourceBundleNames: [ "collections", "components", "core", "effects", "layout", "skins", "sparkEffects", "styles" ],
            currentDomain: ApplicationDomain.currentDomain,
            firstView: "views.BarlessMobileHomeView",
            mainClassName: "BarlessMobile",
            mixins: [ "_BarlessMobile_FlexInit", "_BarlessMobile_Styles", "mx.managers.systemClasses.ActiveWindowManager" ],
