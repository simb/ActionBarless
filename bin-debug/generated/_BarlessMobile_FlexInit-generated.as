...
[Mixin]
public class _BarlessMobile_FlexInit
{
   public function _BarlessMobile_FlexInit()
   {
       super();
   }
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         ...
                         ["mx.collections.ArrayList","BarlessMobile","_BarlessMobile_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
       ...
       { 
           ...
           { 
               ...
               { 
                   trace(ResourceManager.getInstance().getString( "core", 
                         "remoteClassMemoryLeak",
                         ["mx.utils.ObjectProxy","BarlessMobile","_BarlessMobile_FlexInit"]));
               } 
           } 
       } 
       catch (e:Error) 
